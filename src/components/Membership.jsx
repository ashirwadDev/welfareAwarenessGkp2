...
export default function Membership() {
  return (
    <section
      id="membership"
      className="py-16 px-6 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white text-center"
    >
      {/* Heading */}
      ...
      <button
        onClick={() =>
          window.open(
            "https://docs.google.com/forms/d/e/1FAIpQLSdzqq6ILkwH0RUuirFUix0uYOHzBsvdGheRWEvCj7_1z2jn3Q/viewform",
            "_blank"
          )
        }
      ...
      {/* Divider */}
      <div className="my-12 border-t border-gray-300 dark:border-gray-700 max-w-xl mx-auto"></div>
